...
// Inngest Funtion to update user from database
    ...
    async ({event, step})=> {
      ...
      body: `
        <div style="font-family: Arial, sans-serif; line-height: 1.5;">
            ...
            <p>Enjoy the show!</p>
            <p>Thanks for booking with us!<br/>- SeatVerse Team</p>
        </div>`,
    });
    }
)
                ...
                reminderTasks.map(task => sendEmail({
                    ...
                    body: `
                        <div style="font-family: Arial, sans-serif; padding: 20px;">
                            ...
                            <br/>
                            <p>Enjoy the show! <br/>SeatVerse Team</p>
                        </div>
                        `
